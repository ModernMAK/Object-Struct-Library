...
class StringBuffer(PrimitiveStructMixin):
    ...
    def __init__(self, size: int, align_as: int = None, encoding: str = None):
        ...
        PrimitiveStructMixin.__init__(self, size=size, align_as=default_if_none(align_as, 1))
